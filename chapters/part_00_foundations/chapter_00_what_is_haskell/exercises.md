# 第0章 Exercises: Haskellとは何か

## 1. 最小変更で観察する

`examples/Main.hs` を一箇所だけ変更し、`手順ではなく意味を書く言語としてHaskellを見る` という観点で何が変わったかを説明してください。変更前に出力を予想してから実行します。
...
「手順ではなく意味を書く言語としてHaskellを見る」を、次の形式で短く説明してください。
