# 第20章 Exercises: 型クラスとは何か

## 1. 最小変更で観察する

`examples/Main.hs` を一箇所だけ変更し、`型ごとの共通操作を法則付きの抽象として扱う` という観点で何が変わったかを説明してください。変更前に出力を予想してから実行します。
...
「型ごとの共通操作を法則付きの抽象として扱う」を、次の形式で短く説明してください。
