# 第22章 Exercises: 標準的な型クラス

## 1. 最小変更で観察する

`examples/Main.hs` を一箇所だけ変更し、`よく使う型クラスの役割と階層を読む` という観点で何が変わったかを説明してください。変更前に出力を予想してから実行します。
...
「よく使う型クラスの役割と階層を読む」を、次の形式で短く説明してください。
