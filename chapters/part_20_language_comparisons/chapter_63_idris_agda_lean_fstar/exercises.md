# 第63章 Exercises: Idris / Agda / Lean / F*

## 1. 最小変更で観察する

`examples/Main.hs` を一箇所だけ変更し、`依存型と証明の世界との境界を知る` という観点で何が変わったかを説明してください。変更前に出力を予想してから実行します。
...
「依存型と証明の世界との境界を知る」を、次の形式で短く説明してください。
