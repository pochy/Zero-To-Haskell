...
- `OCaml`: この章の判断で使う語。`OCaml` が何を許し、何を防ぐかに注目します。
- `F#`: この章の判断で使う語。`F#` が何を許し、何を防ぐかに注目します。
- `Scala`: この章の判断で使う語。`Scala` が何を許し、何を防ぐかに注目します。
...
A. 小さな実験では構いません。ただし、この章では先に型を読み、ML系・実務関数型との違いを見るための制約を確認します。
