# 第62章 Exercises: OCaml / F# / Scala

## 1. 最小変更で観察する

`examples/Main.hs` を一箇所だけ変更し、`ML系・実務関数型との違いを見る` という観点で何が変わったかを説明してください。変更前に出力を予想してから実行します。
...
「ML系・実務関数型との違いを見る」を、次の形式で短く説明してください。
