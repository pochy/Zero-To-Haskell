# 第65章 Exercises: TypeScript + Effect / fp-ts

## 1. 最小変更で観察する

`examples/Main.hs` を一箇所だけ変更し、`Haskell的発想をTypeScriptで使う限界を知る` という観点で何が変わったかを説明してください。変更前に出力を予想してから実行します。
...
「Haskell的発想をTypeScriptで使う限界を知る」を、次の形式で短く説明してください。
