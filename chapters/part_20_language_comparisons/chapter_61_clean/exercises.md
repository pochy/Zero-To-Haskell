# 第61章 Exercises: Clean

## 1. 最小変更で観察する

`examples/Main.hs` を一箇所だけ変更し、`Haskellに近い遅延純粋言語を比較する` という観点で何が変わったかを説明してください。変更前に出力を予想してから実行します。
...
「Haskellに近い遅延純粋言語を比較する」を、次の形式で短く説明してください。
