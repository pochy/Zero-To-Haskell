# 第59章 Exercises: PureScript

## 1. 最小変更で観察する

`examples/Main.hs` を一箇所だけ変更し、`Haskell的設計をJavaScript圏で使う選択肢を比較する` という観点で何が変わったかを説明してください。変更前に出力を予想してから実行します。
...
「Haskell的設計をJavaScript圏で使う選択肢を比較する」を、次の形式で短く説明してください。
...
```text
□ PureScript を、この章のコードと結びつけて説明できる
□ サンプルの型注釈を読める
□ 純粋関数とIOアクションを区別できる
