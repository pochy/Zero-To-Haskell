# 第25章 Exercises: Monad

## 1. 最小変更で観察する

`examples/Main.hs` を一箇所だけ変更し、`前の結果に応じて次の計算を選ぶ` という観点で何が変わったかを説明してください。変更前に出力を予想してから実行します。
...
「前の結果に応じて次の計算を選ぶ」を、次の形式で短く説明してください。
