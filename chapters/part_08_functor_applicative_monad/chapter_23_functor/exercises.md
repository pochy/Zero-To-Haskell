# 第23章 Exercises: Functor

## 1. 最小変更で観察する

`examples/Main.hs` を一箇所だけ変更し、`文脈を壊さず中身だけ変換する` という観点で何が変わったかを説明してください。変更前に出力を予想してから実行します。
...
「文脈を壊さず中身だけ変換する」を、次の形式で短く説明してください。
