# 第10章 Exercises: 型エイリアスと newtype

## 1. 最小変更で観察する

`examples/Main.hs` を一箇所だけ変更し、`意味の違う値を型で分ける` という観点で何が変わったかを説明してください。変更前に出力を予想してから実行します。
...
「意味の違う値を型で分ける」を、次の形式で短く説明してください。
