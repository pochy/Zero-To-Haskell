# 第15章 Exercises: ループではなく再帰

## 1. 最小変更で観察する

`examples/Main.hs` を一箇所だけ変更し、`データ構造の形に従って計算を書く` という観点で何が変わったかを説明してください。変更前に出力を予想してから実行します。
...
「データ構造の形に従って計算を書く」を、次の形式で短く説明してください。
