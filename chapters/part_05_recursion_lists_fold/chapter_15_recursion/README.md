...
- `再帰`: この章の判断で使う語。`再帰` が何を許し、何を防ぐかに注目します。
- `基底ケース`: この章の判断で使う語。`基底ケース` が何を許し、何を防ぐかに注目します。
- `再帰ケース`: この章の判断で使う語。`再帰ケース` が何を許し、何を防ぐかに注目します。
- `構造的再帰`: この章の判断で使う語。`構造的再帰` が何を許し、何を防ぐかに注目します。
...
A. 小さな実験では構いません。ただし、この章では先に型を読み、データ構造の形に従って計算を書くための制約を確認します。
