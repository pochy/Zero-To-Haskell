# 第17章 Exercises: リスト内包表記

## 1. 最小変更で観察する

`examples/Main.hs` を一箇所だけ変更し、`宣言的にリストを生成する` という観点で何が変わったかを説明してください。変更前に出力を予想してから実行します。
...
「宣言的にリストを生成する」を、次の形式で短く説明してください。
