# 第40章 Exercises: Lensとは何か

## 1. 最小変更で観察する

`examples/Main.hs` を一箇所だけ変更し、`不変データの一部を合成可能に扱う` という観点で何が変わったかを説明してください。変更前に出力を予想してから実行します。
...
「不変データの一部を合成可能に扱う」を、次の形式で短く説明してください。
