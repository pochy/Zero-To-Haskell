# 第38章 Exercises: パーサーコンビネータ

## 1. 最小変更で観察する

`examples/Main.hs` を一箇所だけ変更し、`小さなパーサーを合成して言語を読む` という観点で何が変わったかを説明してください。変更前に出力を予想してから実行します。
...
「小さなパーサーを合成して言語を読む」を、次の形式で短く説明してください。
