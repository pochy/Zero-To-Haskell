# 第46章 Exercises: kind と高階型

## 1. 最小変更で観察する

`examples/Main.hs` を一箇所だけ変更し、`型の型を読み、高カインド型を理解する` という観点で何が変わったかを説明してください。変更前に出力を予想してから実行します。
...
「型の型を読み、高カインド型を理解する」を、次の形式で短く説明してください。
