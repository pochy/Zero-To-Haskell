# 第55章 Exercises: JSONと外部API

## 1. 最小変更で観察する

`examples/Main.hs` を一箇所だけ変更し、`外部表現と内部モデルを分離する` という観点で何が変わったかを説明してください。変更前に出力を予想してから実行します。
...
「外部表現と内部モデルを分離する」を、次の形式で短く説明してください。
