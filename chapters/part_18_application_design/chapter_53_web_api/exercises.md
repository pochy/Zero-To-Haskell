# 第53章 Exercises: Web APIを作る

## 1. 最小変更で観察する

`examples/Main.hs` を一箇所だけ変更し、`ルート、入出力、エラーを型で表す` という観点で何が変わったかを説明してください。変更前に出力を予想してから実行します。
...
「ルート、入出力、エラーを型で表す」を、次の形式で短く説明してください。
