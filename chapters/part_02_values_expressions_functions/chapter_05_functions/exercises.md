# 第5章 Exercises: 関数とは何か

## 1. 最小変更で観察する

`examples/Main.hs` を一箇所だけ変更し、`関数適用、カリー化、部分適用を設計の道具として使う` という観点で何が変わったかを説明してください。変更前に出力を予想してから実行します。
...
「関数適用、カリー化、部分適用を設計の道具として使う」を、次の形式で短く説明してください。
