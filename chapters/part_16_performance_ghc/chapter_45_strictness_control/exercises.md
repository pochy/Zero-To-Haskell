# 第45章 Exercises: 正格性制御

## 1. 最小変更で観察する

`examples/Main.hs` を一箇所だけ変更し、`必要な場所で評価を強制する` という観点で何が変わったかを説明してください。変更前に出力を予想してから実行します。
...
「必要な場所で評価を強制する」を、次の形式で短く説明してください。
