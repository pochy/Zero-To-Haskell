# 第43章 Exercises: GHCの基礎

## 1. 最小変更で観察する

`examples/Main.hs` を一箇所だけ変更し、`Haskellがどうコンパイル・実行されるかを見る` という観点で何が変わったかを説明してください。変更前に出力を予想してから実行します。
...
「Haskellがどうコンパイル・実行されるかを見る」を、次の形式で短く説明してください。
