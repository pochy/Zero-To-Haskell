# 第27章 Exercises: 副作用とは何か

## 1. 最小変更で観察する

`examples/Main.hs` を一箇所だけ変更し、`外界との相互作用を型で境界に出す` という観点で何が変わったかを説明してください。変更前に出力を予想してから実行します。
...
「外界との相互作用を型で境界に出す」を、次の形式で短く説明してください。
