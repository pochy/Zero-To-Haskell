# 第29章 Exercises: Reader / State / Writer

## 1. 最小変更で観察する

`examples/Main.hs` を一箇所だけ変更し、`環境・状態・ログを計算の文脈として扱う` という観点で何が変わったかを説明してください。変更前に出力を予想してから実行します。
...
「環境・状態・ログを計算の文脈として扱う」を、次の形式で短く説明してください。
