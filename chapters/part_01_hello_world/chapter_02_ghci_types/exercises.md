# 第2章 Exercises: GHCiで「型を見る」習慣を作る

## 1. 最小変更で観察する

`examples/Main.hs` を一箇所だけ変更し、`実装より先に型を読む習慣を作る` という観点で何が変わったかを説明してください。変更前に出力を予想してから実行します。
...
「実装より先に型を読む習慣を作る」を、次の形式で短く説明してください。
