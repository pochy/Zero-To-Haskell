# 第70章 Exercises: 大規模演習

## 1. 最小変更で観察する

`examples/Main.hs` を一箇所だけ変更し、`型安全なアーキテクチャを設計・実装・説明する` という観点で何が変わったかを説明してください。変更前に出力を予想してから実行します。
...
「型安全なアーキテクチャを設計・実装・説明する」を、次の形式で短く説明してください。
