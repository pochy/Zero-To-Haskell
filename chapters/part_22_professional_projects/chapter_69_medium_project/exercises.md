# 第69章 Exercises: 中規模演習

## 1. 最小変更で観察する

`examples/Main.hs` を一箇所だけ変更し、`ドメイン型とエラー設計を持つアプリを作る` という観点で何が変わったかを説明してください。変更前に出力を予想してから実行します。
...
「ドメイン型とエラー設計を持つアプリを作る」を、次の形式で短く説明してください。
