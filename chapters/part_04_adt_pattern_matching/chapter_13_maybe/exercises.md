# 第13章 Exercises: Maybe

## 1. 最小変更で観察する

`examples/Main.hs` を一箇所だけ変更し、`値がない可能性を型に出す` という観点で何が変わったかを説明してください。変更前に出力を予想してから実行します。
...
「値がない可能性を型に出す」を、次の形式で短く説明してください。
