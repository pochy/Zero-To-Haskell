# 第33章 Exercises: モジュールシステム

## 1. 最小変更で観察する

`examples/Main.hs` を一箇所だけ変更し、`公開境界で不変条件を守る` という観点で何が変わったかを説明してください。変更前に出力を予想してから実行します。
...
「公開境界で不変条件を守る」を、次の形式で短く説明してください。
