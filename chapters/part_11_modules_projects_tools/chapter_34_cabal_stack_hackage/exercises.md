# 第34章 Exercises: Cabal / Stack / Hackage

## 1. 最小変更で観察する

`examples/Main.hs` を一箇所だけ変更し、`Haskellプロジェクトと依存関係を管理する` という観点で何が変わったかを説明してください。変更前に出力を予想してから実行します。
...
「Haskellプロジェクトと依存関係を管理する」を、次の形式で短く説明してください。
