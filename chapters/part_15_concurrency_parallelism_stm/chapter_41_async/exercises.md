# 第41章 Exercises: 軽量スレッドと async

## 1. 最小変更で観察する

`examples/Main.hs` を一箇所だけ変更し、`並行処理を構造化して扱う` という観点で何が変わったかを説明してください。変更前に出力を予想してから実行します。
...
「並行処理を構造化して扱う」を、次の形式で短く説明してください。
