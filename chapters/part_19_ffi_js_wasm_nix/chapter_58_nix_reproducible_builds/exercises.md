# 第58章 Exercises: Nixと再現可能ビルド

## 1. 最小変更で観察する

`examples/Main.hs` を一箇所だけ変更し、`環境差分を減らすビルド設計を知る` という観点で何が変わったかを説明してください。変更前に出力を予想してから実行します。
...
「環境差分を減らすビルド設計を知る」を、次の形式で短く説明してください。
