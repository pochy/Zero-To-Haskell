# 第36章 Exercises: 例ベースのテスト

## 1. 最小変更で観察する

`examples/Main.hs` を一箇所だけ変更し、`具体例で仕様の基礎を固定する` という観点で何が変わったかを説明してください。変更前に出力を予想してから実行します。
...
「具体例で仕様の基礎を固定する」を、次の形式で短く説明してください。
