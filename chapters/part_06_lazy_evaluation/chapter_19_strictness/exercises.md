# 第19章 Exercises: 遅延評価は万能ではない

## 1. 最小変更で観察する

`examples/Main.hs` を一箇所だけ変更し、`遅延と正格性のトレードオフを知る` という観点で何が変わったかを説明してください。変更前に出力を予想してから実行します。
...
「遅延と正格性のトレードオフを知る」を、次の形式で短く説明してください。
