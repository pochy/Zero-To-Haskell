...
チュートリアル完了後の制作テーマは [ADVANCED_PROJECTS.md](ADVANCED_PROJECTS.md) にまとめています。型安全なCLI/TUI、Markdown解析ツール、DSL付きワークフローエンジン、Web API、並行ジョブキューなどから選べます。
...
def main() -> None:
    ...
    write(ROOT / "ADVANCED_PROJECTS.md", advanced_projects())
